import { FieldDef, NamedViewDef } from '../../store/file';
...
export function AttributesContent({
  ...
  // All three sections stay mounted to preserve unsaved local state when switching sections.
  return (
    <div style={{ flex: 1, overflowY: 'auto', minHeight: 0, display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ display: section === 'views' ? 'flex' : 'none', flex: 1 }}>
        <ContentViews
          initialViews={initialViews}
          fields={initialFields}
          isActive={section === 'views'}
          stableSetOnSubmit={stableSetOnSubmit}
          stableSetMenuActions={stableSetMenuActions}
        />
      </div>
