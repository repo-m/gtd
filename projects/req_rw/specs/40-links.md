...
`src/frontend/components/Field/LinkField.js`
...
- `src/frontend/components/Field/LinkField.tsx`
- `src/frontend/store/fileSliceMemoSelector.ts` – `selectFileLinkset`
- `src/frontend/constants/field_constants.ts` – `FIELD_TYPE_LINKS`
